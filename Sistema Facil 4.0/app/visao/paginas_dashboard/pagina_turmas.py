...
class PaginaTurmas(tk.Frame):
    ...
    def _construir(self):
        ...
        # Form
        card = Card(cont, titulo="📚  Nova Turma", padding=14, raio=12)
        ...
        # Tabela
        tcard = Card(cont, titulo="📋  Turmas Cadastradas", padding=14, raio=12)
    ...
    def _excluir(self, t):
        ...
        if sucesso:
            def desfazer():
                res, m = controlador_dashboard.restaurar_registro("turmas", t)
                if res:
                    Notificacao.sucesso(self, "Turma restaurada!")
                    self._carregar_lista()
                else:
