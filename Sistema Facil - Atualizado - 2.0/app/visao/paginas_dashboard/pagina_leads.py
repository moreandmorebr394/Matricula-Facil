...
class PaginaLeads(tk.Frame):
    ...
    def _construir_formulario(self, parent):
        ...
        # Linha 3: telefone, endereco, numero, complemento
        ...
        self._criar_campo(linha3, "numero", "Numero")
        self._criar_campo(linha3, "complemento", "Complemento")

        # Linha 4: cidade, cep, bairro, estado, status
        linha4 = tk.Frame(form, bg=BRANCO)
        linha4.pack(fill="x", pady=4)
        self._criar_campo(linha4, "cidade", "Cidade")
        self._criar_campo(linha4, "cep", "CEP", mascara="cep")
        self._criar_campo(linha4, "bairro", "Bairro")
