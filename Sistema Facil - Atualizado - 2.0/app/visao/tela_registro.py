...
class TelaRegistro(tk.Toplevel):
    ...
    def _construir_lado_formulario(self):
        ...
        frame.place(x=0, y=0, width=550, height=720)
    ...
    def _construir_lado_visual(self):
        canvas = tk.Canvas(
            self, width=550, height=720,
            bg=AZUL_PRIMARIO, highlightthickness=0, bd=0
        )
        canvas.place(x=550, y=0, width=550, height=720)
        ...
        # Formas decorativas
        canvas.create_oval(-150, 500, 200, 850,
                           fill=AZUL_HOVER, outline="")
        canvas.create_oval(380, -100, 700, 220,
                           fill=AZUL_HOVER, outline="")
        canvas.create_polygon(
            420, 550, 540, 600, 520, 720, 380, 700,
        ...
        for i in range(0, 550, 25):
            canvas.create_oval(i, 280, i + 4, 284,
                               fill=AMARELO_VIBRANTE, outline="")

        # Logo grande
        logo_frame = tk.Frame(canvas, bg=AZUL_PRIMARIO)
        logo_frame.place(relx=0.5, y=110, anchor="center")
        ...
        # Particulas
        for px, py in [(60, 580), (490, 600), (90, 670), (470, 380)]:
